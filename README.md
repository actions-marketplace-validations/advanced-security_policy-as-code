...
```bash
git clone --branch "v2.12.2" https://github.com/advanced-security/policy-as-code.git && cd ./policy-as-code
...
```Powershell
git clone --branch "v2.12.2" https://github.com/advanced-security/policy-as-code.git
cd policy-as-code
